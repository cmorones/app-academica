...
<div class="login-box">
    ...
    <h1><?= Html::img('http://www.iems.cdmx.gob.mx/themes/base/assets/images/logos/Logo_CDMX.png', ['width'=>'70%']) ?></h1>
      </div>
      <div class="login-box-body">
    
        <p class="login-box-msg"><?php echo Yii::t('app', 'Sistema de gestión docente IEMS') ?></p>
